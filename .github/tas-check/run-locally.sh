...
case "$1" in
    "Celeste")
        TAS_URL="https://github.com/VampireFlower/CelesteTAS/archive/dafb7e32ea29ec74e1e1000d2b1559332593a32b.zip"
        TAS_PATH="CelesteTAS-dafb7e32ea29ec74e1e1000d2b1559332593a32b/0 - 100%.tas"
        ;;
    ...
    "StrawberryJam2021")
        ...
        BUNDLE_DOWNLOAD="https://celestemodupdater.0x0a.de/pinned-mods/StrawberryJam2021-Bundle-1d9848d8.zip"
        ;;
