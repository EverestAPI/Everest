...
namespace Celeste.Mod.Helpers.LegacyMonoMod {
    [RelinkLegacyMonoMod("MonoMod.Utils.FastReflectionDelegate")]
    public delegate object LegacyFastReflectionDelegate(object target, params object[] args);

    [RelinkLegacyMonoMod("MonoMod.Utils.FastReflectionHelper")]
    public static class LegacyFastReflectionHelper {

        private static readonly Type[] _DynamicMethodDelegateArgs = { typeof(object), typeof(object[]) };
        private static readonly Dictionary<MethodInfo, LegacyFastReflectionDelegate> _MethodCache = new Dictionary<MethodInfo, LegacyFastReflectionDelegate>();

        private static LegacyFastReflectionDelegate _CreateFastDelegate(MethodBase method, bool directBoxValueAccess = true) {
            ...
            return (LegacyFastReflectionDelegate) dmd.Generate().CreateDelegate(typeof(LegacyFastReflectionDelegate));
        }

        public static LegacyFastReflectionDelegate CreateFastDelegate(this MethodInfo method, bool directBoxValueAccess = true)
            => GetFastDelegate(method, directBoxValueAccess);
        public static LegacyFastReflectionDelegate GetFastDelegate(this MethodInfo method, bool directBoxValueAccess = true) {
            if (_MethodCache.TryGetValue(method, out LegacyFastReflectionDelegate dmd))
                return dmd;
